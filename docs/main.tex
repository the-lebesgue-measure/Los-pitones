...
Se definió una variable epsilon = $1e-8$ para poder hacer divisiones seguras. Se implementó la función elementwise_ops(A,B) que recibe las matrices A y B y hace las siguientes operaciones. \\ 
